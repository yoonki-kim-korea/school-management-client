...
function SchoolfeeManagement() {
  ...
  const callApi = async (query) => {
    const response = await fetch('/api/document/paycondition/list?' + query);
  ...
  const searchSchoolfee = () => {
    ...
    let query  = ''; 
        ...
        query += '&schoolFeeStatus=' + DataExtract.getSelectedValueWithAlternative( document.getElementById('schoolFeeStatus'), '');
