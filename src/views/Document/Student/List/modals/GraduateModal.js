 ...
 * @param {*} param0 
 */
function GraduateModal({ open, onClose, editable,  search, className, ...rest }) {
  ...
  const save = () => {
    ...
    const url = '/api/operclass/student/graduate/update';
    const formData = new FormData();  
    formData.append('udtId', 'root');  
    formData.append('studentStatus', 'GRD');//졸업
