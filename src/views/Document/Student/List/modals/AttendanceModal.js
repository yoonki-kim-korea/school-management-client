 ...
 * @param {*} param0 
 */
function AttendanceModal({ open, onClose, editable, issued, documentInfo, search, className, ...rest }) {
     ...
     */
    const print = async () => {
      const url = '/api/print/excel/attendance';
      ...
      .then(response => {
          if(response.data.result === "success"){            
            alert(`${ExcelInfo.AttendanceDir} 폴더를 확인해주시기 바랍니다. 다음 번 출력을 위해 해당 폴더에 생성된 파일은 다른 곳으로 이동해주시기 바랍니다.`);
          }else{
