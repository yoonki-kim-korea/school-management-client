              ...
              <Table style={{width:1500}}>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">졸업일</TableCell>
                    <TableCell align="left">휴학일</TableCell>
                    <TableCell align="left">상태</TableCell>
                    <TableCell align="left">최종학년</TableCell>
                    <TableCell align="left">최종담임</TableCell>
                    ...
                    >
                      <TableCell align="center">                        
                        <Link
                          ...
                          color="primary"
                          href={"/oldstudent/view/" + student.studentId + "/basicInfo"}
                          target="_self"
                        >
                      ...
                      <TableCell align="left">{DataExtract.getFommatedDate(student.graduateDay,'-')}</TableCell>
                      <TableCell align="left">{DataExtract.getFommatedDate(student.levDay,'-')}</TableCell>
